    ...
    def send_system_notification(user_id, notification_type, data=None):
        ...
        try:
            ...
            notification = Notification(
                ...
                title=f"System Notification: {notification_type}",
            ...
            if user.email:
                NotificationService.send_email_notification(
                    ...
                    f"<p>You have a new notification.</p><p>Type: {notification_type}</p>"
                )
    ...
    def send_hawker_daily_notification(hawker_id):
        ...
        try:
            ...
            if hawker.sms_notifications and hawker.phone:
                try:
                    NotificationService.get_sms_service().send_sms(
                        hawker.phone,
                        message
                    )
                except Exception as e:
